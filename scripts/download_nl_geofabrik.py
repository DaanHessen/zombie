...
def progress_bar(current, total, prefix="", bar_len=40):
    ...
    sys.stdout.write(f"\r  Downloading [{bar}] {pct*100:5.1f}% {size_str}  ")
    sys.stdout.flush()
...
class PoiHandler(osmium.SimpleHandler):
    ...
    def _print_progress(self):
        ...
        if now - self.last_print > 0.3:
            ...
            sys.stdout.write(f"\r  Extracting Netherlands... {spin} {self.count:,} POIs found  ")
            sys.stdout.flush()
            self.last_print = now
...
def process():
    ...
    print()
    print("  +====================================================+")
    print("  |      NETHERLANDS POI EXTRACTION (Local Dev Data)    |")
    print("  +====================================================+")
    print()
