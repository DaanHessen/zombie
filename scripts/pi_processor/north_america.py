...
def download_file(url, filename):
    print(f"Downloading https://download.geofabrik.de/north-america-latest.osm.pbf...")
    max_retries = 150
    for attempt in range(max_retries):
        try:
            ...
            time.sleep(300)
    raise Exception(f"Failed to download {https://download.geofabrik.de/north-america-latest.osm.pbf} after {{max_retries}} attempts.")
